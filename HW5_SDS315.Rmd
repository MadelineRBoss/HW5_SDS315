...
ggplot() + geom_histogram(aes(chi_sq_stats)) + labs(title = "Chi Sqaure Distrubution for Letter Frequencies (English)", x = "Chi Sqaure Statistic")
```
